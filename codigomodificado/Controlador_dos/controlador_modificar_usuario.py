from Visual_dos.ventana_modificar_usuario import VentanaModificarUsuario
...
class ControladorModificarUsuario:
    ...
    def __init__(self, datos_usuario):
        ...
        self.__ventana_modificar.label_1.setText(f"{self.__ventana_modificar.label_1.text()} {datos_usuario[1]}")
    ...
    def modificar_usuario (self):
        ...
        UsuarioDAO().modificar_usuario(dni_usuario,nombre_modificado,apellido_modificado,nombre_usuario_modificado,contrasenia_modificada)