...
class ControladorModificarUsuario:
    ...
    def __init__(self, datos_producto):
        ...
        self.__ventana_modificar.label_1.setText(f"{self.__ventana_modificar.label_1.text()} {datos_producto[1]}")
    ...
    def modificar_usuario (self):
        ...
        ProductoDAO().modificar_usuario(dni_usuario,nombre_modificado,apellido_modificado,nombre_usuario_modificado,contrasenia_modificada)