...
class VentanaAgregarProducto (QWidget):
    ...
    def __init__(self, controlador):
        ...
        self.label_2 = QLabel("Ingrese la cantidad actual")
        ...
        self.line_edit_2.setPlaceholderText("cantidad actual")
        self.line_edit_2.setFixedSize(QSize(200,30))
        
        self.label_3 = QLabel("Ingrese el stock minimo")
        ...
        self.line_edit_3.setPlaceholderText("stock minimo")
        self.line_edit_3.setFixedSize(QSize(200,30))
        
        self.label_4 = QLabel("Ingrese el precio del producto")
        ...
        self.line_edit_4.setPlaceholderText("precio del producto")
